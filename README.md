...
Load the latest [jQuery library](http://jquery.com), the `js/min/jquery.idealforms.min.js` plugin and the `less/min/jquery.idealforms.min.css` stylesheet into your project.
...
When you finish editing the user cofig don't forget to compile `less/jquery.idealforms.less` into `css`.

...
* Useful to validate usernames from a database; just pull a list of the usernames that are already taken and pass in an array. The array can be updated and Ideal Forms will respond accordingly. Just store the array in an external variable.

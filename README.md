...
Every form is registered in the `$.idealforms.forms` namespace after initialization in the order they've been created, beginning at `$0`. This means that you can manually modify a particular option of any form instead of overriding it with `setOptions` :
